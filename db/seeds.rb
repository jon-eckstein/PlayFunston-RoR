...
Observation.create!(condition_code: 2, temp: 60, wind_chill: 50, wind_mph: 15, wind_gust_mph: 20, go_funston: -1)
Observation.create!(condition_code: 2, temp: 0, wind_chill: 0, wind_mph: 0, wind_gust_mph: 0, go_funston: -1)
Observation.create!(condition_code: 2, temp: 50, wind_chill: 40, wind_mph: 10, wind_gust_mph: 15, go_funston: -1)